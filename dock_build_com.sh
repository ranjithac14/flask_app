docker build -t login_image --target login-env .

docker build -t login_authenticate_image --target login-authenticate-env .

docker build -t db_image --target db-env .

docker build -t app_image --target app-env .
